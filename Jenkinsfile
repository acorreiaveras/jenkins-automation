          ...
          script {
            ...
            if ($FLAG == '1') {
              ...
              docker.withRegistry('https://102212442704.dkr.ecr.us-west-1.amazonaws.com', 'ecr:us-west-1:demo-ecr-credentials') {
                ...
                sh 'ansible-playbook /var/lib/jenkins/deploy-myapp/deploy.yml  --user=jenkins --extra-vars ImageName=env.REPOSITORY --extra-vars imageTag=env.NAME --extra-vars Build=env.BUILD_ID'
              } else {
